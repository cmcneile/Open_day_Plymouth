...
\vspace{3mm}
Guardian Univ. Mathematics League Table

\begin{itemize}
\item  2023: {\red \textbf{2$^{\textrm{nd}}$}} in the UK for satisfaction with Mathematics teaching.

\item  2022: {\red \textbf{6$^{\textrm{th}}$}} in the UK for satisfaction with Mathematics teaching.
...
\item 2021: {\red \textbf{8$^{\textrm{th}}$}} in the UK for satisfaction with Mathematics teaching.\vspace{3mm}\\


\item 2020: {\red \textbf{4$^{\textrm{th}}$}} overall in the UK.\vspace{3mm}\\
...
%%
\frame{\frametitle{Academic interests}

  There is a lot of accademic content in the degree. For example,
...
becacem the warden of the Royal Mint.
...
\frame{\frametitle{Mathematics and Your Future}
