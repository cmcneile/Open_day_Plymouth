...
\author{Dr Gosia Wojtys\\malgorzata.wojtys@plymouth.ac.uk\\Centre for Mathematical Sciences}
...
\begin{itemize}
    ...
    \item Assessment: generally 60-80\% exam, 40-20\% CW. Some CW-only modules.
\end{itemize}
\end{minipage}
...
\begin{itemize}
    ...
    \item 15 hours of classes (lectures, computer labs etc.) per week. \on2
...
\begin{itemize}
\item  2022 Guardian Univ. Mathematics League Table
...
\begin{array}{rr}
\begin{minipage}[r]{7cm}
Year long placements (typically earn \pounds 18\,k)
\vspace{-0.3cm}
\begin{itemize}
